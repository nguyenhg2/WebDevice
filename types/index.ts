...
export interface Game { name: string; slug: string; steamId: string | null; genres: string[]; sizeGb: number; price: number; isFree: boolean; description: string; coverImage: string | null; officialUrl: string | null; minSpecs: SpecBlock; recSpecs: SpecBlock; }
