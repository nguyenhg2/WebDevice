...
export type BenchmarkConfidence = "measured" | "matched" | "manual" | "estimated";
...
export interface Gpu { name: string; slug: string; brand: string; benchmarkScore: number; category: string; tdp: number | null; vram: number | null; priceRangeVnd: string; isLaptop: boolean; commonInVietnam: boolean; imageUrl?: string | null; }
