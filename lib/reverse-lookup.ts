...
export function getBenchmarkVideos(gameSlug: string, gpuSlug?: string) { return benchmarks.filter((b) => b.gameSlug === gameSlug && (!gpuSlug || b.gpuSlug === gpuSlug) && b.videoTestUrl).slice(0, 12); }
